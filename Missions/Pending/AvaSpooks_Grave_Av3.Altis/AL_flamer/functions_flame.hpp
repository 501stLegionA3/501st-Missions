...
fnc_attk_flamer = {
	...
	_nearflamer = (ASLToAGL getPosASL _flamer) nearEntities ["CAManBase",5]; {_x setDamage (getDammage _x + _damage_flamer); [_x,[_tip,200]] remoteExec ["say3d"];} forEach (_nearflamer-[_flamer]);
