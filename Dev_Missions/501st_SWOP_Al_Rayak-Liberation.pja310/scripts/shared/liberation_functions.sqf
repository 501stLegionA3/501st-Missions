...
F_crateToStorage = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_ia_crate_to_storage.sqf";
F_crateFromStorage = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_ia_crate_from_storage.sqf";
F_crateCheckValue = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_ia_crate_checkValue.sqf";
