if ( isMultiplayer ) then {
	...
	IA_liberation_arsenalUsePreset = ["ArsenalUsePreset",1] call BIS_fnc_getParamValue;
	IA_liberation_mapmarkers = ["MapMarkers",1] call bis_fnc_getParamValue;
	IA_liberation_mobilerespawn = ["MobileRespawn",1] call bis_fnc_getParamValue;
	IA_liberation_mobilearsenal = ["MobileArsenal",1] call bis_fnc_getParamValue;
	IA_liberation_ailogistics = ["AiLogistics",1] call bis_fnc_getParamValue;
} else {
	...
	IA_liberation_arsenalUsePreset = 1;
	IA_liberation_mapmarkers = 1;
	IA_liberation_mobilerespawn = 1;
	IA_liberation_mobilearsenal = 1;
	IA_liberation_ailogistics = 1;
};
...
if (IA_liberation_arsenalUsePreset == 1) then {IA_liberation_arsenalUsePreset = true} else {IA_liberation_arsenalUsePreset = false};
if (IA_liberation_mapmarkers == 1) then {IA_liberation_mapmarkers = true; GREUH_allow_mapmarkers = true; GREUH_allow_platoonview = true} else {IA_liberation_mapmarkers = false; GREUH_allow_mapmarkers = false; GREUH_allow_platoonview = false; show_platoon = false; show_teammates = false; show_nametags = false};
if (IA_liberation_mobilerespawn == 1) then {IA_liberation_mobilerespawn = true} else {IA_liberation_mobilerespawn = false};
if (IA_liberation_mobilearsenal == 1) then {IA_liberation_mobilearsenal = true} else {IA_liberation_mobilearsenal = false};
if (IA_liberation_ailogistics == 1) then {IA_liberation_ailogistics = true} else {IA_liberation_ailogistics = false};
