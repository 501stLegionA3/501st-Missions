...
IA_liberation_storage_buildings = [IA_liberation_small_storage_building,IA_liberation_large_storage_building];
IA_liberation_crates = [IA_liberation_supply_crate,IA_liberation_ammo_crate,IA_liberation_fuel_crate];
IA_liberation_upgrade_buildings = [IA_liberation_recycle_building,IA_liberation_air_vehicle_building,IA_liberation_heli_slot_building,IA_liberation_plane_slot_building];
IA_liberation_air_slots = [IA_liberation_heli_slot_building,IA_liberation_plane_slot_building];
...
IA_liberation_friendly_air_classnames = [];
{air_vehicles_classnames pushback (_x select 0); IA_liberation_friendly_air_classnames pushback (_x select 0);} foreach air_vehicles;
