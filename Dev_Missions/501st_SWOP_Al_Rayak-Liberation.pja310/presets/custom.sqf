...
crewman_classname = "SWOP_Rebel_Scarif_T1";								// This defines the crew for vehicles. 																									Default is "B_crew_F".
pilot_classname = "SWOP_Rebel_navy_pil";							// This defines the pilot for helicopters. 																								Default is "B_Helipilot_F".
KP_liberation_little_bird_classname = "swop_LAAT";	// These are the little birds which spawn on the Freedom or at Chimera base.															Default is "B_Heli_Light_01_F".
...
KP_liberation_recycle_building = "land_SW_K2SO";						// The building defined to unlock FOB recycling functionality.																			Default is "Land_CarService_F".
KP_liberation_air_vehicle_building = "Land_Mining_drill";					// The building defined to unlock FOB air vehicle functionality.																		Default is "Land_Radar_Small_F".
...
air_vehicles = [
	...
	["Scar_Uwing",500,550,475],										//CH-47 Chinook (Armed)
	...
	["swop_LAATwolf",350,300,675]										//CH-47 Chinook (Armed)
];
...
blufor_squad_inf_light = [
	"SWOP_Rebel_desert_a280",
	"SWOP_Rebel_desert_dh17",
	"SWOP_Rebel_desert_e11",
	"SWOP_Rebel_desert_a280",
	"SWOP_Rebel_desert_dh17",
	"SWOP_Rebel_desert_e11",
	"SWOP_Rebel_desert_a280",
...
blufor_squad_inf = [
	...
	"SWOP_Rebel_desert_e11",
	"SWOP_Rebel_desert_e11",
	"SWOP_Rebel_desert_demolisher",
	"SWOP_Rebel_desert_mg",
	"SWOP_Rebel_desert_mg"
];

// AT specialists squad.
blufor_squad_at = [
	"SWOP_Rebel_desert_aa",
	"SWOP_Rebel_desert_aa",
	"SWOP_Rebel_desert_a280",
	"SWOP_Rebel_desert_dh17",
	"SWOP_Rebel_desert_dh17",
...
// Force recon squad.
blufor_squad_recon = [
	"SWOP_Rebel_desert_sniper",
	"SWOP_Rebel_desert_e11",
	"SWOP_Rebel_desert_com"
];

// Paratroopers squad.
blufor_squad_para = [
	"SWOP_Rebel_desert_a280",
	"SWOP_Rebel_desert_jumper",
	"SWOP_Rebel_desert_assault",
	"SWOP_Rebel_desert_assault",
	"SWOP_Rebel_desert_assault",
	"SWOP_Rebel_desert_assault",
	"SWOP_Rebel_desert_assault",
...
opfor_officer = "SWOP_Sand_stromtrooper_SL";								//Officer
opfor_team_leader = "SWOP_Sand_stromtrooper_TL";									//Team Leader
opfor_squad_leader = "SWOP_Sand_stromtrooper_Corp";								//Squad Leader
opfor_sentry = "SWOP_Sand_stromtrooper";									//Rifleman (Lite)
opfor_rifleman = "SWOP_Sand_stromtrooper";									//Rifleman
opfor_rpg = "SWOP_Sand_stromtrooper_AA";												//Rifleman (LAT)
opfor_grenadier = "SWOP_Sand_stromtrooper_t";								//Grenadier
opfor_machinegunner = "SWOP_Sand_stromtrooper_dlt";								//Autorifleman
opfor_heavygunner = "SWOP_Sand_stromtrooper_dlt";							//Heavy Gunner
opfor_marksman = "SWOP_Sand_stromtrooper";									//Marksman
opfor_sharpshooter = "SWOP_Sand_stromtrooper";							//Sharpshooter
opfor_sniper = "SWOP_Sand_stromtrooper";								//Sniper
opfor_at = "SWOP_Sand_stromtrooper_AA";												//AT Specialist
opfor_aa = "SWOP_Sand_stromtrooper_AA";												//AA Specialist
opfor_medic = "SWOP_Sand_stromtrooper";											//Combat Life Saver
opfor_engineer = "SWOP_Sand_stromtrooper";									//Engineer
opfor_paratrooper = "SWOP_Spec_StormCommando";									//Paratrooper
...
militia_vehicles = [
	"SW_SpeederBike"													//GAZ-233014 (Armed)
];
