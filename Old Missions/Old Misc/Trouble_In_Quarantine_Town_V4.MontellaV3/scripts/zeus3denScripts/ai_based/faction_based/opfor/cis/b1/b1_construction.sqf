//Adds Changes B1 to Construction
//Created by Peterson 01/01/2019
  {
	...
	_x setobjecttextureglobal [0,"OPTRE_Vehicles\Elephant\data\flooring_co.paa"];	
	_x setobjecttextureglobal [1,"OPTRE_Vehicles\Elephant\data\flooring_co.paa"];
	_x setobjecttextureglobal [2,"OPTRE_Vehicles\Elephant\data\flooring_co.paa"];
	...
	hintSilent "Existing B1 droids have been changed to Construction";
